...
namespace ciclojobs.DAL.Migrations
{
    ...
    [Migration("20220301122717_CreaFacturas")]
    partial class CreaFacturas
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ciclojobs.DAL.Entities.Contrato", b =>
                {
                    b.Property<int>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<DateTime>("FehchaAlta")
                        .HasColumnType("datetime(6)");
            ...
            modelBuilder.Entity("ciclojobs.DAL.Entities.ContratoEstado", b =>
                {
                    b.Property<int>("EstadoID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ciclojobs.DAL.Entities.Facturas", b =>
                {
                    b.Property<int>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ciclojobs.DAL.Entities.Contrato", b =>
                {
                    b.HasOne("ciclojobs.DAL.Entities.Empresa", "Empresa")
                        .WithMany()
                        .HasForeignKey("EmpresaID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ciclojobs.DAL.Entities.ContratoEstado", "EstadoContrato")
                        .WithMany()
            ...
            modelBuilder.Entity("ciclojobs.DAL.Entities.Facturas", b =>
                {
                    b.HasOne("ciclojobs.DAL.Entities.Contrato", "Contrato")
                        .WithMany()
