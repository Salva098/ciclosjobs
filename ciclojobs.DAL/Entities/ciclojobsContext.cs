...
namespace ciclojobs.DAL.Entities
{
    public partial class ciclojobsContext : DbContext
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            {
                optionsBuilder.UseMySql("server=51.254.98.153;port=6969;user=myuser;password=123456789;database=ciclojobs", Microsoft.EntityFrameworkCore.ServerVersion.Parse("8.0.26-mysql"));
            }
        }
